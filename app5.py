...
<p style='color:#444; margin-top:0;'>Use the quick filters below or pick a section above to get started.</p>
    ...
    # Quick Jump in an expander — click the header to expand / collapse.
    # Default expanded=True so it's visible on first load; user can collapse it.
    with st.expander("🔎 Quick Jump", expanded=True):
