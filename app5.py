...
b1, b2, b3, _spacer = st.columns([1.4, 1.4, 1.4, 4])
with b1:
    st.button(
        "📋 Schedule",
...
if st.session_state.section == "schedule":
    ...
    if logo_b64:
        logo_html = (
            ...
            f'alt="GITAA" '
            f'style="max-width: 380px; width: 60%; height: auto; '
            f'margin-bottom: 1.4rem; '
            f'background-color: #000000; padding: 18px 28px; border-radius: 10px;" />'
        )
    else:
        logo_html = ""
    ...
    st.markdown(
        ...
        <div style='text-align:center; color:#0B5394; padding:3rem 1rem;'>
            ...
            <p>Select <b>Course Schedule</b>, <b>Course Repository</b>, or <b>Reports</b> above to get started.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
